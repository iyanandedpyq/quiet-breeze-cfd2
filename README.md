...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/quiet-breeze-cfd2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-breeze-cfd2
```

A live public deployment of this template is available at [https://quiet-breeze-cfd2.templates.workers.dev](https://quiet-breeze-cfd2.templates.workers.dev)
